...
nuget.exe pack SystemInterface\SystemInterface.nuspec -OutputDirectory publish -Properties Configuration="Release" -Version "0.26.0" -Symbols -SymbolPackageFormat snupkg -NonInteractive -ForceEnglishOutput
nuget.exe pack SystemWrapper\SystemWrapper.nuspec -OutputDirectory publish -Properties Configuration="Release" -Version "0.26.0" -Symbols -SymbolPackageFormat snupkg -NonInteractive -ForceEnglishOutput
